...
const images = [
  {
    id: 1,
    imgUrl: mahsol1,
    title: "خطی که مهمتر است را می‌توان در این قسمت نوشت",
    description:
      "   بخشی از اوایل مقاله به اندازه 2 خط اینجا نوشته شود، لورم ایپسوم متنی ساختگی است که در طراحی نگارش می‌شود...",
  },
  {
    id: 2,
    imgUrl: mahsol2,
    ...
    <>
      <div className=" container flex flex-col md:flex-row items-center md:items-start gap-4 md:gap-8 w-full rounded overflow-hidden shadow-lg">
        <img
          src={imgUrl}
          alt="Product"
          className="w-[427px] h-[318px] rounded-md"
        />
        <div className="flex flex-col w-full md:w-1/2 p-4">
          ...
          <div className="flex justify-between  gap-2 mt-4 text-10">
            <div className="flex  items-center f">
              ...
              <span className="inline-block   rounded-full px-3 py-1 text-sm font-semibold text-gray-700 pr-0 ">
                {" "}
                | 5دقیقه{" "}
              </span>
            </div>
